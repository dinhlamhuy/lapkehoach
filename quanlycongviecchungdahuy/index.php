<title>Kế hoạch công việc đã hủy</title>
...
<div class="container-fluid">
    <div class="row shadow py-3 mt-1">
        <div class="col-md-12">
            ...
            <h2 class="float-left"><b>Danh sách kế hoạch công việc đã hủy</b></h2>
<div class="table-responsive">
                <hr>
        
                <table id="quanlycongviecchungdahuy" width="100%" class="table w-100 table-bordered table-striped display">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="congvieccha" id="congvieccha_update" class="form-control myselect2 w-100" style="width:100% !important;" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="ngaybatdau" class="form-control" id="ngaybatdau_update" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><b>Thời hạn công việc</b>(*)</label>
                                <input type="date" name="ngayketthuc" class="form-control" id="ngayketthuc_update" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="noidung" id="ndcv_update" class="form-control" disabled></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="ghichu" id="ghichu_update" class="form-control" disabled></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="nvthuchien" id="nvthuchien_update" class="form-control myselect2" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="trangthaicv" id="trangthaicv_update" class="form-control" disabled>
